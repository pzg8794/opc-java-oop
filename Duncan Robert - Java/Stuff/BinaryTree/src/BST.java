...
public class BST 
{
   ...
   {  Object data;   // Realistic case, this could be quite large
...
// Interchange the .data fields on two BSTnodes passed
   ...
   {  Comparable temp = (Comparable) d.data;  d.data = s.data;  s.data = temp; }
   ...
   // In the returns, the call where we are dealing with the replacement
      ...
      {//Check to see if we indeed DID find the value
         if ( deleteNode != null && data.equals(deleteNode.data) )
