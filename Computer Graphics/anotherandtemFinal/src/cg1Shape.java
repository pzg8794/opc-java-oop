...
/**
 * Class to create different type of shapes.
 * @author Piter Garcia
 *
 */
public class cg1Shape extends simpleShape
{
	...
	//x and y coordinates - theta angle
	...
	//containers to facilitate coding
...
//    	makeCone(0.5f, 10, 10);	
	...
	/**
	 * sets the x, y and z coordinates of a plane.
	 * @param cubeShape
	 * @param count1
	 * @param cubeShape1
	 * @param count2
	...
	/**
	 * set the x, y and z coordinates of a plane.
	 * @param firstVertix
	 * @param step
	 * @param secondVertix
	 */
	...
	/**
	 * sets the new x and y points in a plane to a new vertex.
	 * @param tempAngle
	 */
