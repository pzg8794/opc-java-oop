...
/**
 * 
 * Class to test all methods to created an frame art that illustrate
 * an image.
 * @author Piter Garcia
 *
 */
public class tessMain implements GLEventListener, KeyListener
{
	...
	public void init(GLAutoDrawable drawable)
	{
		...
		gl2.glClearColor (0.0f, 2.0f, 0.2f, 1.0f);
	...
	public void createShapes(GL2 gl2)
	{
		...
		for(i = 0; i < objs; i++) {
	        ...
	        Buffer textCoords = myShape.getUV();
	        ...
	        long dataCor = myShape.getNVerts() * 2l * 4l;
	        ...
	        gl2.glBufferSubData(GL.GL_ARRAY_BUFFER, vertBsize, dataCor , textCoords);
    ...
    public static void main(String [] args)
    {
        ...
        Frame frame = new Frame("CG1 - FINAL EXAMN I");
