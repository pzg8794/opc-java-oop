...
public class lightingParams
{
    ...
    private float diffuse[] = {0.89f, 0.0f, 0.0f, 1.0f}, specular[] = {1.0f,1.0f,1.0f,1.0f}, shineness=10.0f;
    ...
    public void setUpPhong (int program, GL2 gl2)
    {
        ...
        int specul = gl2.glGetUniformLocation(program,"specularColor");
        int shiny = gl2.glGetUniformLocation(program,"shineness");
        ...
        gl2.glUniform1f(shiny,shineness);
