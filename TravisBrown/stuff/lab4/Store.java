...
public class Store {
    ...
    public Book produceBook( String line ) {
    	...
    	Integer cost = Integer.parseInt(temp[2]);
    	
    	if( temp.length <= 3)
    		return new PaperbackBook(temp[0], temp[1], cost);
    	    	
    	else if( temp[3].contains("http"))
    		return new ElectronicBook(temp[0], temp[1], cost, temp[3]);
    	
    	else if( temp[3].contains("cassette"))
    		return new ElectronicBook(temp[0], temp[1], cost, temp[3]);
    	
    	else if( temp[3].equals("leather") || temp[3].equals("cloth"))
    		return new HardcoverBook(temp[0], temp[1], cost, temp[3]);
    	
    	else
    		return new AudioBook(temp[0], temp[1], cost, temp[3]);
    }
