...
public class Driver1 {
    ...
    MyHashSet aHashSet = new MyHashSet();         //MyHashSet object
    long milliSeconds = 0;
    int objectKind = 0;
    ...
    //Initializes the timw.
    public void init()  {
        milliSeconds = System.currentTimeMillis();
    }
    //Prints time at the end of operation
    public void end()   {
   ...
   public static void main(String args[] )      {
        Driver1 aDriver = new Driver1();    //Creates an object of Driver1 for testing.
        aDriver.init();
        aDriver.testIt();
        aDriver.end();
        System.exit(0);
